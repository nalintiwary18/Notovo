...
export const DesktopSidebar = ({
  ...
  return (
    <>
      <motion.div
        className={cn(
          "h-full min-h-0 px-4 py-4 hidden  md:flex md:flex-col bg-neutral-100 dark:bg-neutral-800 w-[300px] shrink-0 overflow-hidden",
          className
        )}
        animate={{
...
export const MobileSidebar = ({
  ...
  return (
    <>
      <div
        className={cn(
          "h-14 px-4 flex flex-row md:hidden items-center bg-neutral-900 w-full fixed top-0 left-0 z-30"
        )}
        {...props}
      >
        {/* Hamburger — left */}
